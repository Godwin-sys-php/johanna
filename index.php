          ...
          <div class="row">
            <div class="col-md-6">
              <div class="detail-box">
                <h1>Bienvenue chez Johanna Business</h1>
                <p>
                  Découvrez Johanna Business, votre partenaire de confiance en
                  agriculture et pisciculture en République Démocratique du
                  Congo. Nous nous engageons à fournir des produits de haute
                  qualité pour nourrir notre nation tout en soutenant le
                  développement durable et l'innovation dans le secteur
                  agroalimentaire.
                </p>
                <!-- <div class="btn-box">
                <a href="" class="btn-1">
        ...
        <div class="row">
          ...
          <div class="col-md-9">
            <div class="detail-box">
              ...
              <p>
                Chez Johanna Business, notre mission est de révolutionner
                l'agriculture et la pisciculture en RDC grâce à des pratiques
                durables et innovantes. Nous nous efforçons de fournir des
                produits sains et nutritifs tout en respectant l'environnement
                et en soutenant les communautés locales.
              </p>
              <h4>Nos Valeurs</h4>
              <ul>
                <li>
                  Durabilité : Protéger notre environnement pour les générations
                  futures.
                </li>
                <li>
                  Qualité : Offrir les meilleurs produits grâce à des normes
                  rigoureuses.
                </li>
                <li>
                  Innovation : Utiliser la technologie et les méthodes modernes
                  pour améliorer nos pratiques.
                </li>
                <li>
                  Communauté : Soutenir et travailler avec les petits producteurs  pour un rendement  plus durable en facilitant l’accès aux marchés. 
                </li>
                <li>
                Jeunesse et genre: travailler avec les groupement  féminin pour leur implication  et autonomisation. Partenariat  stratégique  et technique  avec les jeunes entrepreneurs
                </li>
              </ul>
              <!-- <div class="btn-box">
              <a href="" class="btn-1">
    ...
    <section class="service_section layout_padding">
      <div class="container py_mobile_45">
        <div class="heading_container heading_center">
          <h2>Pourquoi Choisir Johanna Business ?</h2>
        </div>
        <div class="row">
          <div class="col-md-4">
            <div class="box">
              <div class="box_content">
                ...
                <div class="detail-box">
                  ...
                  <p>
                    Connaissance approfondie des conditions climatiques et du
                    sol en RDC.
                  </p>
                </div>
              </div>
            ...
            <div class="box">
              <div class="box_content">
                ...
                <div class="detail-box">
                  ...
                  <p>
                    Pratiques agricoles et piscicoles respectueuses de
                    l'environnement.
                  </p>
                </div>
              </div>
            ...
            <div class="box">
              <div class="box_content">
                  ...
                  >
                    <g id="Dairy_Product" data-name="Dairy Product">
                      <g id="Outline">
                        ...
                        <path
                          d="M440,256a8,8,0,0,0-8,8v32a8,8,0,0,0,16,0V264A8,8,0,0,0,440,256Z"
                        />
                      </g>
                    </g>
                  </svg>
                ...
                <div class="detail-box">
                  ...
                  <p>
                    Adoption des dernières technologies pour améliorer la
